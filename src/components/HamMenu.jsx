    ...
    return (
      ...
      >
        <div className="relative w-6 h-5 flex flex-col justify-between items-center">
          <span
            className={`bg-primary h-[2px] w-full rounded-full absolute transition-all duration-300 ease-in-out ${
              isOpen ? "rotate-45 top-[10px]" : "rotate-0 top-0"
            }`}
          ></span>
  
          <span
            className={`bg-primary h-[2px] w-full rounded-full absolute transition-all duration-300 ease-in-out top-[10px] ${
