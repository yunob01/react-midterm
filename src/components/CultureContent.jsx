    ...
    return (
      <div className=" max-w-4xl mx-auto px-6 py-12 font-serif">
        <section className="mb-12">
          <p className="uppercase text-sm tracking-widest mb-2 text-[#6A4E42]">Coffee Origins</p>
          <h1 className="text-3xl italic font-bold mb-4 text-[#6A4E42]">The rich history of coffee</h1>
          <p className="mb-6 text-[#6A4E42]">
          ...
          <p className="text-sm italic text-[#6A4E42]">
        ...
        <section className="mb-12">
          <h2 className="text-2xl italic font-bold mb-4 text-[#6A4E42]">The legend of coffee origin begins in Ethiopia</h2>
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="flex-1">
              <p className="mb-4 text-[#6A4E42]">
        ...
        <section className="mb-12">
          <h2 className="text-2xl italic font-bold mb-4 text-[#6A4E42]">
          ...
          <h3 className="text-xl md:text-2xl font-semibold italic mb-2 text-[#6A4E42]">Wisdom in a cup</h3>
          <p className="mb-4 text-[#6A4E42]">
          ...
          />
          <p className="text-md text-center italic mt-6 text-[#6A4E42]">
